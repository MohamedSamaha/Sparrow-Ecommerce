...
{
    public class CustomerContactInfoCustomerRepository : GenericRepository<CustomerContactInfo>, ICustomerContactInfoRepository
    {
        public CustomerContactInfoCustomerRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
